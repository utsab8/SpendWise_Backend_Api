// controllers/reportsController.js - Analytics and Reports API
  ...
  try {
    ...
    Object.keys(categoryBreakdown).forEach((category) => {
      const percentage = totalExpenses > 0 
        ? Math.round((categoryBreakdown[category].total / totalExpenses) * 100) 
        : 0;
      categoryBreakdown[category].percentage = percentage;
    });
    ...
    console.log('✅ Reports data prepared');
